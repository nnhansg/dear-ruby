...
describe DearRuby::ApiClient do
  ...
  describe 'params_encoding in #build_request' do
    let(:config) { DearRuby::Configuration.new }
    let(:api_client) { DearRuby::ApiClient.new(config) }

    it 'defaults to nil' do
      expect(DearRuby::Configuration.default.params_encoding).to eq(nil)
  ...
  describe 'timeout in #build_request' do
    ...
    it 'defaults to 0' do
      expect(DearRuby::Configuration.default.timeout).to eq(0)
